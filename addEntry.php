...
<head>
    ...
    <title>Post new add - ArtisanBD</title>
    ...
    <body>
       ...
       <?php
        ...
        ?>
        <h1 id="addPost">Post Your New Add</h1>
          <?php
            //session_start();
        ...
        <div class="addForm">
            ...
            <form action="addRegister.php" method="POST" enctype="multipart/form-data">
                ...
                Give Your Add a title:<br>
                
                <input type="text" name="addTitle" required>*<br>
                
                Choose your city:<br>
                
                <select id="slct1" name="slct1" onchange="populate(this.id,'slct2')" required>
                ...
                <input name="description" type="text" reqired><br>
                
                Enter Your Mobile Number:<br>
                
                <input name="mobile" type="text" reqired><br>
                
                <input name="mobile1" type="text" reqired>
